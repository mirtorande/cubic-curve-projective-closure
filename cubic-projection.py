...
curves_affine = {
    ...
    'x^3 + xy^2 + y + Hx + J = 0    (H=1/2 J=-1/2)': '1x^3 + 1xy^2 + .5x + 1y + -.5',
    'x^3 + xy^2 + x + J = 0    (J=5)': '1x^3 + 1xy^2 + 1x + 5',
    'x^3 + xy^2 + 1 = 0': '1x^3 + 1xy^2 + 1',
    'x^3 - xy^2 - x^2 + Hx + Iy + J = 0    (H=2, I=-2, J=2)': '1x^3 + -1xy^2 + -1x^2 + 2x + -2y + 2',
    'x^3 - xy^2 + 1 = 0': '1x^3 + -1xy^2 + 1',
    'x^2y + y^2 - x + y + J = 0    (J=0)': '1x^2y + 1y^2 + -1x + 1y + 0',
    'x^2y + y^2 + y + J = 0    (J=1/4)': '1x^2y + 1y^2 + 1y + .25',
    'x^2y + y^2 - 1 = 0': '1x^2y + 1y^2 + -1',
    'x^2y - x + y + J = 0    (J=3)': '1x^2y + -1x + 1y + 3',
    'x^2y - x = 0': '1x^2y + -1x',
    'x^2y - x + 1 = 0': '1x^2y + -1x + 1',
    '$x^2y + y + 1 = 0$': '1x^2y + 1y + 1',
    'x^2y + 1 = 0': '1x^2y + 1',
    'x^3 - y^2 + x + J = 0    (J=2)': '1x^3 + -1y^2 + 1x + 2',
    'x^3 - y^2 - x + J = 0    (J=1/4)': '1x^3 + -1y^2 + -1x + .25',
